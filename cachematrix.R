...
## that can cache its inverse. makeCacheMatrix() generates a list of 
...
makeCacheMatrix <- function(x = matrix()) {
  # initializes m as cache value 
    m <- NULL
  # implements the function set(y) - y is a matrix
    set <- function(y) {
      x <<- y
      m <<- NULL
  ...
  # implements the function get() 
    get <- function() x
  # implements the function setonverse(y) - y should be generated by
  # `cacheSolve`
